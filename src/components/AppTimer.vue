<template>
	...
	<AppActionButton @emitClicked="start" icon="play_arrow" txt="play" :disabled="stopwatchRunning" />
	<AppActionButton @emitClicked="stop" icon="stop" txt="stop" :disabled="!stopwatchRunning" />
</template>
